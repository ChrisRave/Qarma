...
namespace ProjetQarma.Models
{
    ...
    {        //*****Classe Utilisateur*****
        ...
        int CreerUtilisateur(InfosPersos infosPersos, string adresse, string mail, string telephone, int soldeBisous, int qarma, string password, TypeUtilisateur typeUtilisateur, string CentreInteret, string Propose, string Imagepath, string Appartement);        
        void ModifierUtilisateur(int id, InfosPersos infosPersos, string adresse, string mail, string telephone, int soldeBisous, int qarma, TypeUtilisateur typeUtilisateur, string CentreInteret, string Propose, string Imagepath, string Appartement);
