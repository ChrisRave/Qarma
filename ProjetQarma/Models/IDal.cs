...
namespace ProjetQarma.Models
{
    ...
    {        //*****Classe Utilisateur*****
        ...
        void CreerService(int id, TypeService typeservice, int montantBisous, string description, string titre, int infosPersosId, string imagepath);

        void SupprimerService(string nom);

        void SupprimerService(int id);

        void ModifierService(int id, TypeService typeservice, int montantbisous, string description, string titre, string imagePath);
        ...
        void ProposerService(int id, TypeService typeservice, int montantBisous, string description, string titre, int infosPersosId, string imagePath);


        void ModifierProposition(int id, TypeService typeservice, int montantBisous, string description, string imagePath);
